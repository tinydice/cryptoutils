...
class extendedKey:
    ...
    def parse_from_seed(cls, seed):
        """This function instantiates an extendedKey instance from a mnemonic seed"""
    ...
    def parse_from_bip32(cls, bip32key, parent_pubkey=None):
        """This function instantiates an extendedKey instance from a serialized extendedKey (xprv/ xpub)"""
    ...
    def derive_child_xprv(self, path):
        """
    ...
    def derive_pubkey(self):
        """
        This function derives a public key from a xprv extendedKey instance
        """
    ...
    def serialize(self):
        """
        The serialized xprv or xpub of the extendedKey instance in bytes
        """
